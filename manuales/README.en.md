...
- [`manual_driver_sonido.en.md`](manual_driver_sonido.en.md) — the
...
- [`manual_motor_colision_ia.en.md`](manual_motor_colision_ia.en.md) — the
...
- [`manual_subsistema_grafico.en.md`](manual_subsistema_grafico.en.md) — the
  ...
  color is managed.
- [`manual_niveles.en.md`](manual_niveles.en.md) — the format of the 15
